export default {
  ...
  account: {
    ...
    singleNode: "单节点",
    dualNode: "双节点",
    node2DisabledTip: "第二节点未启用，无法选择双节点权限",
  },
  config: {
  ...
  hysteria: {
    ...
    node2: {
      ...
      disable: "禁用",
      remark: "节点备注",
      remarkPlaceholder: "请输入节点备注名称",
      port: "节点端口",
      portPlaceholder: "自动分配（主节点端口+1）",
      portTip: "第二节点端口将自动设置为主节点端口+1",
      status: "运行状态",
      running: "运行中",
      stopped: "已停止",
      socks5Config: "SOCKS5 出站配置",
      socks5: {
        addr: "SOCKS5 地址",
        addrPlaceholder: "请输入 SOCKS5 代理地址，格式：host:port",
        username: "用户名",
        usernamePlaceholder: "请输入 SOCKS5 用户名（可选）",
        password: "密码",
        passwordPlaceholder: "请输入 SOCKS5 密码（可选）",
      },
      saveSocks5Config: "保存 SOCKS5 配置",
      testConnection: "测试连接",
    },
  },
};
