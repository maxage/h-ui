export default {
  ...
  account: {
    ...
    dualNode: "Dual Node",
    node2DisabledTip: "Second node is not enabled, cannot select dual node access",
  },
  config: {
  ...
  hysteria: {
    ...
    node2: {
      title: "Second Node Configuration",
      enable: "Enable",
      disable: "Disable",
      remark: "Node Remark",
      remarkPlaceholder: "Enter node remark name",
      port: "Node Port",
      portPlaceholder: "Auto-assigned (Main node port + 1)",
      portTip: "Second node port will be automatically set to main node port + 1",
      status: "Running Status",
      running: "Running",
      stopped: "Stopped",
      socks5Config: "SOCKS5 Outbound Configuration",
      socks5: {
        addr: "SOCKS5 Address",
        addrPlaceholder: "Enter SOCKS5 proxy address, format: host:port",
        username: "Username",
        usernamePlaceholder: "Enter SOCKS5 username (optional)",
        password: "Password",
        passwordPlaceholder: "Enter SOCKS5 password (optional)",
      },
      saveSocks5Config: "Save SOCKS5 Configuration",
